    ...
    <div name="experience" className='w-full h-fit bg-gradient-to-b from-black to-gray-800 text-white'>
        <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
            ...
            <div className='flex flex-col md:flex-row p-6 w-full shadow-md shadow-gray-500 rounded-lg h-fit md:hover:scale-105 md:duration-500'>
                <div className='h-auto w-full md:w-3/4 rounded-t-lg text-white md:rounded-tr-none md:rounded-bl-lg bg-black flex flex-col justify-center items-center p-4'>
